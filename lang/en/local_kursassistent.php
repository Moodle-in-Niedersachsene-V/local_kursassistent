...
$string['templatewizard_installiert'] = 'The local_coursetemplatewizard plugin is installed. The template course category is configured there under "Course template wizard".';
$string['templatewizard_fehlt'] = 'The "Apply course template" feature requires the additional plugin local_coursetemplatewizard. Without it, the building block does not appear in the course assistant.';
