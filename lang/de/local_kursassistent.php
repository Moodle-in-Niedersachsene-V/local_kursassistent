...
$string['aktiv'] = 'Aktiv';
$string['aktiv_help'] = 'Nur aktive Bausteine erscheinen im Kursassistenten. Wird ein Baustein deaktiviert, bleibt er hier erhalten und kann später wieder eingeschaltet werden. Bereits in Kurse eingefügte Inhalte bleiben davon unberührt.';
...
$string['dateiauswaehlen_help'] = 'Über die Schaltfläche „Datei wählen" öffnet sich die Dateiauswahl von Moodle. Dort stehen alle an dieser Website eingerichteten Speicherorte zur Verfügung, etwa der Upload vom eigenen Rechner oder ein angebundener Cloud-Speicher. Bilder werden im Baustein direkt angezeigt, alle anderen Dateien als Link zum Herunterladen.';
...
$string['icon_help'] = 'Das Symbol, das im Kursassistenten und in der Überschrift des erzeugten Bausteins erscheint. Es stehen zwölf mitgelieferte Symbole zur Auswahl; sie werden vom Plugin selbst bereitgestellt und benötigen keine Verbindung ins Internet.';
...
$string['modname_help'] = 'Nur beim Typ „Aktivität" von Bedeutung. Legt fest, welche Moodle-Aktivität angelegt wird, wenn die Lehrkraft den Baustein anklickt. Zur Auswahl stehen alle auf dieser Website installierten Aktivitäten.';
$string['neuerbaustein'] = 'Neuer Baustein';
$string['platzhalter'] = 'Platzhaltertext (nur bei Typ „Text“)';
$string['platzhalter_help'] = 'Nur beim Typ „Text" von Bedeutung. Dieser Text steht im Eingabefeld bereits vorgeschrieben, wenn die Lehrkraft den Baustein auswählt. Er dient als Formulierungshilfe und kann vollständig überschrieben werden. Ein angefangener Satz wie „Nach diesem Kursabschnitt können die Teilnehmenden ..." hat sich bewährt.';
...
$string['titel'] = 'Titel';
$string['titel_help'] = 'Der Name, den die Lehrkraft im Kursassistenten sieht. Er erscheint außerdem als Überschrift in dem Baustein, der im Kurs erzeugt wird. Kurze, sprechende Bezeichnungen sind am hilfreichsten, zum Beispiel „Lernziele" oder „Arbeitsauftrag".';
$string['typ'] = 'Typ';
$string['typ_aktivitaet'] = 'Aktivität';
$string['typ_bild'] = 'Bild';
$string['typ_datei'] = 'Datei';
$string['typ_help'] = 'Bestimmt, was beim Anklicken des Bausteins geschieht.<ul><li><strong>Text</strong>: Die Lehrkraft gibt einen Text ein, der als Textfeld im Kurs erscheint.</li><li><strong>Datei</strong> und <strong>Bild</strong>: Es öffnet sich die Dateiauswahl mit allen eingerichteten Speicherorten.</li><li><strong>Video</strong>: Auswahl zwischen vorhandenem PeerTube-Video, eigenem Upload und einem Link zu einer anderen Plattform.</li><li><strong>Aktivität</strong>: Es öffnet sich das gewohnte Formular zum Anlegen einer Moodle-Aktivität.</li></ul>Die Zuordnung zu den Gruppen im Kursassistenten erfolgt automatisch anhand dieser Auswahl.';
